...
export interface TextProps {
    /**
     * Тип элемента для отображения в виде (строка или компонент).
     */
    as?: ElementType;
    /**
     * Дочерние элементы (текст или другие компоненты).
     */
    children?: ReactNode;
    /**
    ...
    className?: string;
    /**
     * Устанавливает выравнивание текста внутри компонента.
     */
    align?: TextAlignValue;
    /**
     * Устанавливает возможен ли перенос текста внутри компонента.
     */
    overflow?: TextOverflowValue;
    /**
     * Максимальное количество строк текста (работает в сочетании с `overflow`).
     */
    maxLines?: number;
    /**
    ...
    style?: CSSProperties;
    /**
     * Устанавливает цвет текста внутри компонента.
     */
    color?: string;
    /**
     * Устанавливает типографику текста внутри компонента.
     */
    typography?: TextTypographyValue;
    /**
     * Устанавливает жирность текста внутри компонента.
     */
    weight?: "bold" | "light" | "medium" | "regular";
}
/**
 * Базовый примитив для представления текстовых данных.
 */
